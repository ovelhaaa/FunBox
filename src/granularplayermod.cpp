...
void GranularPlayerMod::setEnvelopeMode(int env_mode)
{
    env_mode_ = env_mode;
}
...
void GranularPlayerMod::Process(float speed,
                              float transposition,
                              float grain_size,
                              float width)
{
    ...
    idxSpeed_   = NegativeInvert(&phs_, speed_) * variable_size_;  // Speed phasors control the movement through the entire sample, NegativeInvert function processes the phasor
